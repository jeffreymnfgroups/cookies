        ...
        <div className="container mx-auto px-4 max-w-2xl text-center">
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm">
            ...
            <div className="space-y-4 mb-8 text-gray-700">
              <p className="text-lg">
                Your inquiry has been received, and I&apos;m so excited to help
                bring your cookie vision to life!
              </p>
              <p className="text-lg">
                I&apos;ll personally review your request and get back to you
                within 1-2 business days with all the sweet details.
              </p>
              <p className="font-medium text-bakery-pink-dark">
                Can&apos;t wait to create something special for your
                celebration!
              </p>
            </div>
